  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <StatCard title="总注册船员" value={totalDistributors} icon={Users} description="所有已注册的船员数量" />
        <StatCard title="待审核申请" value={pendingApprovals} icon={Clock} description="等待管理员批准的申请" />
        <StatCard title="已批准船员" value={approvedDistributors} icon={UserCheck} description="已通过审核的船员" />
        <StatCard
          title="已拒绝申请"
          value={rejectedDistributors}
          icon={ListChecks}
          description="已被拒绝的船员申请"
        />
      </div>
      ...
      <div className="bg-brandBlack-light border border-gold-dark/50 shadow-md shadow-gold-dark/5 p-6 rounded-lg">
        ...
        <p className="text-gold-light/70">您可以在“船员审核”页面管理新的注册申请。</p>
